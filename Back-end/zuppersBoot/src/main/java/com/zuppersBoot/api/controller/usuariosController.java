...
public class usuariosController {
	...
	public Usuarios adicionar(@Valid @RequestBody Usuarios usuario) {
		return usuariosRepository.save(usuario);
	}
	
	//Atualizar user específico
	@PutMapping("/{usuarioId}")
	public ResponseEntity<Usuarios> atualizar(@Valid @PathVariable Long usuarioId, @RequestBody Usuarios usuario){
